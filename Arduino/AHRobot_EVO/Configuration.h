...
#define MAX_ACCEL 150           // Maximun motor acceleration in (steps/seg2)/1000. Max recommended value:280
#define MAX_SPEED 20000         // Maximun speed in steps/seg. Max absolute value: 32767!!

#define MIN_ACCEL 20
#define MIN_SPEED 1000
#define SCURVE_LOW_SPEED 500
#define SCURVE_HIGH_SPEED 15000
...
#define TABLE_LENGTH 905
#define TABLE_WIDTH 475
...
#define ROBOT_INITIAL_POSITION_Y ROBOT_MIN_Y   // Measured from center of the robot pusher to the table border
